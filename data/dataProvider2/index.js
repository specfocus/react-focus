...
var fakeServer_1 = __importDefault(require("../fakeServer"));
exports.default = (function (type) {
    ...
    var dataProviderPromise = getDataProvider(type);
    ...
    var dataProviderWithGeneratedData = new Proxy(defaultDataProvider, {
        get: function (_, name) {
            return function (resource, params) {
                return dataProviderPromise.then(function (dataProvider) {
...
var getDataProvider = function (type) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, fakeServer_1.default)(process.env.REACT_APP_DATA_PROVIDER || '')];
            case 1:
                _a.sent();
                /**
                 ...
                 */
                if (type === 'graphql') {
                    return [2 /*return*/, Promise.resolve().then(function () { return __importStar(require('./graphql')); }).then(function (factory) { return factory.default(); })];
                }
                return [2 /*return*/, Promise.resolve().then(function () { return __importStar(require('./rest')); }).then(function (provider) { return provider.default; })];
        }
    });
}); };
var defaultDataProvider = {
    // @ts-ignore
    create: function () { return Promise.resolve({ data: { id: 0 } }); },
    // @ts-ignore
    delete: function () { return Promise.resolve({ data: {} }); },
    deleteMany: function () { return Promise.resolve({}); },
    ...
    // @ts-ignore
    getOne: function () { return Promise.resolve({ data: {} }); },
    // @ts-ignore
    update: function () { return Promise.resolve({ data: {} }); },
