...
var weightedBoolean = function (likelyhood) {
    return en_1.default.datatype.number(99) < likelyhood;
};
...
var randomDate = function (minDate, maxDate) {
    ...
    var randomRange = en_1.default.datatype.number({ max: range });
...
var randomFloat = function (min, max) {
    return parseFloat(en_1.default.datatype.number({ min: min, max: max, precision: 0.01 }).toFixed(2));
};
