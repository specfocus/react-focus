...
const SearchState_1 = require("features/search/SearchState");
...
const SearchControl = () => {
    ...
    if (isSmall || widget === exports.SEARCH_WIDGET) {
        return ((0, jsx_runtime_1.jsx)(exports.SearchButton, { disabled: widget === exports.SEARCH_WIDGET, onClick: handleWidget }, void 0));
    }
...
const SearchMenu = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(Menu_2.default, Object.assign({ id: "density-menu", variant: "selectedMenu", anchorEl: null, anchorOrigin: {
            ...
            horizontal: 'left',
                    ...
                    onWidget();
                } }, { children: [(0, jsx_runtime_1.jsx)(Typography_1.default, Object.assign({ variant: "caption", sx: { flexGrow: 1 } }, { children: "Expand" }), void 0), (0, jsx_runtime_1.jsx)(ChevronRight_1.default, { sx: { flexGrow: 0 } }, void 0)] }), `search-widget`), (0, jsx_runtime_1.jsx)(Divider_1.default, {}, void 0), history.map((text, index) => ((0, jsx_runtime_1.jsx)(MenuItem_1.default, Object.assign({ onClick: event => {
                    setInput(text);
                    if (onClose) {
    ...
    return ((0, jsx_runtime_1.jsx)(Widget_1.default, Object.assign({ actions: {
            ...
            close: {
                ...
                label: 'Close',
                            ...
                            // size="small"
                            variant: !idx ? 'filled' : 'outlined', clickable: true }, void 0) }), String(idx)))) }), void 0), (0, jsx_runtime_1.jsx)(Divider_1.default, {}, void 0), (0, jsx_runtime_1.jsxs)(Stack_1.default, Object.assign({ sx: { flexGrow: 1, overflowY: 'auto' } }, { children: [results.map((result, index) => ((0, jsx_runtime_1.jsxs)(Accordion_1.default, Object.assign({ expanded: expanded === `panel-${index}`, onChange: handleExpand(`panel-${index}`) }, { children: [(0, jsx_runtime_1.jsxs)(AccordionSummary_1.default, Object.assign({ expandIcon: (0, jsx_runtime_1.jsx)(ExpandMore_1.default, {}, void 0), "aria-controls": `panel${index}bh-content`, id: `panel${index}bh-header` }, { children: [(0, jsx_runtime_1.jsx)(Typography_1.default, Object.assign({ sx: { width: '33%', flexShrink: 0 } }, { children: result.primary }), void 0), (0, jsx_runtime_1.jsx)(Typography_1.default, Object.assign({ sx: { color: 'text.secondary' } }, { children: result.secondary }), void 0)] }), void 0), (0, jsx_runtime_1.jsx)(AccordionDetails_1.default, { children: typeof result.details === 'string' ? ((0, jsx_runtime_1.jsx)(Typography_1.default, Object.assign({ variant: "caption" }, { children: result.details }), void 0)) : typeof result.details === 'function' ? (result.details()) : (result.details) }, void 0)] }), void 0))), (0, jsx_runtime_1.jsx)(Divider_1.default, {}, void 0)] }), void 0)] }), void 0) }), void 0));
};
