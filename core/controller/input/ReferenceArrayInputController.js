...
var ReferenceArrayInputController = function (_a) {
    ...
    var _f = (0, useReferenceArrayInputController_1.useReferenceArrayInputController)({
        basePath: basePath,
        filter: filter,
    ...
    var debouncedSetFilter = (0, react_1.useCallback)((0, debounce_1.default)(setFilter, 500), [
        setFilter,
    ]);
