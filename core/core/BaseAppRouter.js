...
var BaseAppRouter = function (props) {
    var getPermissions = (0, auth_1.useGetPermissions)();
    ...
    var _a = (0, util_1.useSafeSetState)([]), computedChildren = _a[0], setComputedChildren = _a[1];
    ...
    var renderCustomRoutesWithoutLayout = function (route, routeProps) {
        ...
        if (route.props.component) {
            return (0, react_1.createElement)(route.props.component, __assign(__assign({}, routeProps), { title: props.title }));
        }
    };
    ...
    if ((typeof children === 'function' &&
        ...
        return (react_1.default.createElement(react_router_dom_1.Switch, null,
            customRoutes
                ...
                return (0, react_1.cloneElement)(route, {
                    key: key,
    ...
    return (react_1.default.createElement("div", null,
        ...
        react_1.default.createElement(react_router_dom_1.Switch, null,
            ...
            react_1.default.createElement(react_router_dom_1.Route, { path: "/", render: function () {
                    return (0, react_1.createElement)(layout, {
                        dashboard: dashboard,
                        logout: logout,
                        menu: menu,
                        theme: theme,
