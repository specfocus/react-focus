...
function validateResponseFormat(response, type, logger // eslint-disable-line no-console
    ...
    if (core_1.fetchActionsWithArrayOfIdentifiedRecordsResponse.includes(type) &&
        ...
        logger("The response to '".concat(type, "' must be like { data : [{ id: 123, ...}, ...] }, but at least one received data item do not have an 'id' key. The dataProvider is probably wrong for '").concat(type, "'"));
        throw new Error('ra.notification.data_provider_error');
    }
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, effects_1.select)(function (state) { return state.admin.ui.optimistic; })];
            case 2:
                ...
                return [4 /*yield*/, (0, effects_1.all)([
                        (0, effects_1.put)({ type: "".concat(type, "_LOADING"), payload: payload, meta: meta }),
                        (0, effects_1.put)({ type: actions_1.FETCH_START }),
                    ])];
            case 3:
                _b.sent();
                return [4 /*yield*/, (0, effects_1.call)(dataProvider[(0, core_1.sanitizeFetchType)(restType)], meta.resource, payload)];
            case 4:
                response = _b.sent();
            ...
            case 5:
                _b.sent();
                return [4 /*yield*/, (0, effects_1.put)({ type: actions_1.FETCH_END })];
            case 6:
                _b.sent();
                return [3 /*break*/, 14];
            case 7:
            ...
            case 8:
                _b.sent();
                return [4 /*yield*/, (0, effects_1.put)({ type: actions_1.FETCH_ERROR, error: error_1 })];
            case 9:
                _b.sent();
                return [3 /*break*/, 14];
            case 10: return [4 /*yield*/, (0, effects_1.cancelled)()];
            case 11:
                if (!_b.sent()) return [3 /*break*/, 13];
                return [4 /*yield*/, (0, effects_1.put)({ type: actions_1.FETCH_CANCEL })];
            case 12:
                _b.sent();
                return [2 /*return*/];
...
var fetch = function (dataProvider) {
    return function watchFetch() {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, effects_1.takeEvery)(exports.takeFetchAction, handleFetch, dataProvider)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
