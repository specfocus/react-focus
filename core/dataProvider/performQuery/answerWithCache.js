...
var answerWithCache = function (_a) {
    ...
    var response = (0, replyWithCache_1.getResultFromCache)(type, payload, resourceState);
    dispatch({
        type: "".concat(action, "_SUCCESS"),
        payload: response,
        requestPayload: payload,
        meta: __assign(__assign({}, rest), { resource: resource, fetchResponse: (0, getFetchType_1.default)(type), fetchStatus: fetchActions_1.FETCH_END, fromCache: true }),
    });
