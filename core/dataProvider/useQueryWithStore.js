...
var defaultDataSelector = function (query) { return function (state) {
    var key = JSON.stringify(__assign(__assign({}, query), { type: (0, getFetchType_1.default)(query.type) }));
...
var useQueryWithStore = function (query, options, dataSelector, totalSelector, isDataLoaded) {
    ...
    var requestSignatureRef = (0, react_1.useRef)(requestSignature);
    var data = (0, react_redux_1.useSelector)(dataSelector);
    var total = (0, react_redux_1.useSelector)(totalSelector);
