...
export declare const getReferences: (state: ReduxState, reference: any, relatedTo: any) => {} | undefined;
export declare const getReferencesByIds: (state: ReduxState, reference: string, ids: Identifier[]) => {} | null;
