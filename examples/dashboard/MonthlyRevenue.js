...
var MonthlyRevenue = function (props) {
    var value = props.value;
    var translate = (0, app_1.useTranslate)();
    return (React.createElement(CardWithIcon_1.default, { to: "/commands", icon: AttachMoney_1.default, title: translate('pos.dashboard.monthly_revenue'), subtitle: value }));
};
