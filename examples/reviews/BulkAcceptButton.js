...
var noSelection = [];
var BulkAcceptButton = function (props) {
    ...
    var _b = (0, app_1.useUpdateMany)('reviews', selectedIds, { status: 'accepted' }, {
    ...
    return (React.createElement(app_1.Button, { label: "resources.reviews.action.accept", onClick: approve, disabled: loading },
        React.createElement(ThumbUp_1.default, null)));
};
