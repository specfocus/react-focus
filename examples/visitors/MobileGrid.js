...
var Root = (0, styles_1.styled)('div')(function (_a) {
    ...
    var theme = _a.theme;
    return (_b = {},
        _b["&.".concat(classes.root)] = { margin: '1em' },
        ...
        _b["& .".concat(classes.cardContent)] = __assign(__assign({}, theme.typography.body1), { display: 'flex', flexDirection: 'column' }),
        _b);
});
var MobileGrid = function (_a) {
    ...
    return (React.createElement(Root, { className: classes.root }, ids.map(function (id) { return (React.createElement(Card_1.default, { key: id, className: classes.card },
