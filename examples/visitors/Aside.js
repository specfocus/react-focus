...
var AsideRoot = (0, styles_1.styled)('div')(function (_a) {
    var _b, _c;
    var theme = _a.theme;
    return (_b = {},
...
var Aside = function (_a) {
    ...
    return (React.createElement(AsideRoot, { className: classes.root }, record && React.createElement(EventList, { record: record, basePath: basePath })));
};
Aside.propTypes = {
    record: prop_types_1.default.any,
    basePath: prop_types_1.default.string,
};
var StyledStepper = (0, styles_1.styled)(material_1.Stepper)({
    '&': {
        background: 'none',
        border: 'none',
        marginLeft: '0.3em',
...
var EventList = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(StyledStepper, { orientation: "vertical" }, events.map(function (event) { return (React.createElement(material_1.Step, { key: "".concat(event.type, "-").concat(event.data.id), expanded: true, active: true, completed: true },
...
var ReviewRoot = (0, styles_1.styled)('div')({
    '& .clamp': {
        display: '-webkit-box',
        '-webkit-line-clamp': 3,
...
var Review = function (_a) {
    var record = _a.record, basePath = _a.basePath;
    var translate = (0, app_1.useTranslate)();
    return record ? (React.createElement(ReviewRoot, null,
        React.createElement(material_1.Typography, { variant: "body2", gutterBottom: true },
        ...
        React.createElement(material_1.Typography, { variant: "body2", color: "textSecondary", className: "clamp" }, record.comment))) : null;
};
