...
var CompanyCreate = function (props) {
    var classes = useStyles();
    return (React.createElement(app_1.Create, __assign({}, props, { actions: false }),
...
var CustomLayout = function (props) { return (React.createElement(material_1.CardContent, null,
    React.createElement(material_1.Box, { display: "flex" },
        React.createElement(material_1.Box, { paddingTop: 1 },
            React.createElement(material_1.Avatar, null,
                React.createElement(Business_1.default, null))),
