...
var defaultTheme = process.env.NODE_ENV !== 'production'
    ? (0, styles_1.unstable_createMuiStrictModeTheme)(components_1.defaultTheme)
    : (0, styles_1.createMuiTheme)(components_1.defaultTheme);
var ApplicationsDashboard = function (_a) {
    ...
    return (React.createElement(styles_1.ThemeProvider, { theme: (0, styles_1.createMuiTheme)(theme) },
