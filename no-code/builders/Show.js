...
var Show = function (props) { return (react_1.default.createElement(components_1.Show, __assign({}, props),
    react_1.default.createElement(exports.ShowForm, null))); };
exports.Show = Show;
var ShowForm = function (props) {
    ...
    return (react_1.default.createElement(components_1.SimpleShowLayout, __assign({}, props), resourceConfiguration.fields
