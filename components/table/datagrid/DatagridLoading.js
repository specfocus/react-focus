...
var DatagridLoading = function (_a) {
    ...
    return oneSecondHasPassed ? (React.createElement(material_1.Table, { className: (0, classnames_1.default)(classes.table, className), size: size },
        React.createElement(material_1.TableHead, null,
            React.createElement(material_1.TableRow, { className: classes.row },
                expand && (React.createElement(material_1.TableCell, { padding: "none", className: classes.expandHeader })),
                hasBulkActions && (React.createElement(material_1.TableCell, { padding: "checkbox", className: classes.expandIconCell },
                    React.createElement(material_1.Checkbox, { className: "select-all", color: "primary", checked: false }))),
                times(nbChildren, function (key) { return (React.createElement(material_1.TableCell, { variant: "head", className: classes.headerCell, key: key },
        ...
        React.createElement(material_1.TableBody, null, times(nbFakeLines, function (key1) { return (React.createElement(material_1.TableRow, { key: key1, style: { opacity: 1 / (key1 + 1) } },
            expand && (React.createElement(material_1.TableCell, { padding: "none", className: classes.expandIconCell },
                React.createElement(material_1.IconButton, { className: classes.expandIcon, component: "div", "aria-hidden": "true" },
                    React.createElement(ExpandMore_1.default, null)))),
            hasBulkActions && (React.createElement(material_1.TableCell, { padding: "checkbox", className: classes.expandIconCell },
                React.createElement(material_1.Checkbox, { className: "select-all", color: "primary", checked: false }))),
            times(nbChildren, function (key2) { return (React.createElement(material_1.TableCell, { className: classes.rowCell, key: key2 },
