...
var ExpandRowButton = function (_a) {
    ...
    return (React.createElement(IconButton_1.default, __assign({ "aria-label": translate(expanded ? 'ra.action.close' : 'ra.action.expand'), "aria-expanded": expanded, "aria-controls": expandContentId, className: (0, classnames_1.default)(classes.expandIcon, (_b = {},
