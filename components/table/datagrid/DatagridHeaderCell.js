...
var DatagridHeaderCell = function (props) {
    ...
    return (React.createElement(material_1.TableCell, __assign({ className: (0, classnames_1.default)(className, field.props.headerClassName), align: field.props.textAlign, variant: "head" }, rest), updateSort &&
