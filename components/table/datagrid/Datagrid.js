...
var Datagrid = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(DatagridContextProvider_1.default, { value: contextValue },
        React.createElement(material_1.Table, __assign({ ref: ref, className: (0, classnames_1.default)(classes.table, className), size: size }, (0, core_1.sanitizeListRestProps)(rest)),
