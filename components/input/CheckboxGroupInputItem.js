...
var StyledFormControlLabel = (0, styles_1.styled)(FormControlLabel_1.default)((_a = {},
    _a["& .".concat(classes.checkbox)] = {
        height: 32,
    },
    _a));
var CheckboxGroupInputItem = function (props) {
    ...
    return (React.createElement(StyledFormControlLabel, { htmlFor: "".concat(id, "_").concat(getChoiceValue(choice)), key: getChoiceValue(choice), onChange: onChange, control: React.createElement(Checkbox_1.default, __assign({ id: "".concat(id, "_").concat(getChoiceValue(choice)), color: "primary", className: classes.checkbox, checked: value
