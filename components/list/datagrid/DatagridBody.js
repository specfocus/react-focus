...
var DatagridBody = React.forwardRef(function (_a, ref) {
    var basePath = _a.basePath, children = _a.children, className = _a.className, data = _a.data, expand = _a.expand, hasBulkActions = _a.hasBulkActions, hover = _a.hover, ids = _a.ids, onToggleItem = _a.onToggleItem, resource = _a.resource, row = _a.row, rowClick = _a.rowClick, rowStyle = _a.rowStyle, selectedIds = _a.selectedIds, isRowSelectable = _a.isRowSelectable, rest = __rest(_a, ["basePath", "children", "className", "data", "expand", "hasBulkActions", "hover", "ids", "onToggleItem", "resource", "row", "rowClick", "rowStyle", "selectedIds", "isRowSelectable"]);
    return (React.createElement(material_1.TableBody, __assign({ ref: ref, className: (0, classnames_1.default)('datagrid-body', className, useDatagridStyles_1.DatagridClasses.tbody) }, rest), ids.map(function (id, rowIndex) {
        var _a;
        return (0, react_1.cloneElement)(row, {
            basePath: basePath,
            className: (0, classnames_1.default)(useDatagridStyles_1.DatagridClasses.row, (_a = {},
                _a[useDatagridStyles_1.DatagridClasses.rowEven] = rowIndex % 2 === 0,
                _a[useDatagridStyles_1.DatagridClasses.rowOdd] = rowIndex % 2 !== 0,
                _a[useDatagridStyles_1.DatagridClasses.clickableRow] = rowClick,
                _a)),
            expand: expand,
