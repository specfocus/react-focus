...
var StyledTableCell = (0, styles_1.styled)(material_1.TableCell)(function (_a) {
    ...
    return (_b = {},
        ...
        _b["& .Mui-active .MuiSvgIcon-root"] = {
            display: 'inline',
        },
        _b);
});
var DatagridHeaderCell = function (props) {
    var className = props.className, field = props.field, currentSort = props.currentSort, updateSort = props.updateSort, isSorting = props.isSorting, rest = __rest(props, ["className", "field", "currentSort", "updateSort", "isSorting"]);
    var resource = (0, core_1.useResourceContext)(props);
    var translate = (0, core_1.useTranslate)();
    return (React.createElement(StyledTableCell, __assign({ className: (0, classnames_1.default)(className, field.props.headerClassName), align: field.props.textAlign, variant: "head" }, rest), updateSort &&
        ...
        React.createElement(material_1.TableSortLabel, { active: currentSort.field ===
            ...
            React.createElement(core_1.FieldTitle, { label: field.props.label, source: field.props.source, resource: resource })))) : (React.createElement(core_1.FieldTitle, { label: field.props.label, source: field.props.source, resource: resource }))));
};
