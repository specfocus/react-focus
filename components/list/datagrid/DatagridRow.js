...
var DatagridRow = react_1.default.forwardRef(function (props, ref) {
    ...
    return (react_1.default.createElement(core_1.RecordContextProvider, { value: record },
        react_1.default.createElement(material_1.TableRow, __assign({ ref: ref, className: className, key: id, style: style, hover: hover, onClick: handleClick }, rest),
            expand && (react_1.default.createElement(material_1.TableCell, { padding: "none", className: useDatagridStyles_1.DatagridClasses.expandIconCell }, expandable && (react_1.default.createElement(ExpandRowButton_1.default, { className: (0, classnames_2.default)(useDatagridStyles_1.DatagridClasses.expandIcon, (_a = {},
                    _a[useDatagridStyles_1.DatagridClasses.expanded] = expanded,
                    _a)), expanded: expanded, onClick: handleToggleExpand, expandContentId: "".concat(id, "-expand") })))),
            ...
            react_1.default.Children.map(children, function (field, index) {
                return (0, react_1.isValidElement)(field) ? (react_1.default.createElement(DatagridCell_1.default, __assign({ key: "".concat(id, "-").concat(field.props.source || index), className: (0, classnames_1.default)("column-".concat(field.props.source), useDatagridStyles_1.DatagridClasses.rowCell), record: record }, { field: field, basePath: basePath, resource: resource }))) : null;
            })),
