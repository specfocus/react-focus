...
var ListGuesser = function (props) {
    var controllerProps = (0, core_1.useListController)(props);
    return (React.createElement(core_1.ListContextProvider, { value: controllerProps },
...
var ListViewGuesser = function (props) {
    ...
    (0, react_1.useEffect)(function () {
        if (ids.length > 0 && data && !inferredChild) {
            var inferredElements = (0, core_1.getElementsFromRecords)(ids.map(function (id) { return data[id]; }), listFieldTypes_1.default);
            var inferredChild_1 = new core_1.InferredElement(listFieldTypes_1.default.table, null, inferredElements);
            process.env.NODE_ENV !== 'production' &&
                // eslint-disable-next-line no-console
                console.log("Guessed List:\n\nexport const ".concat(inflection_1.default.capitalize(inflection_1.default.singularize(resource)), "List = props => (\n    <List {...props}>\n").concat(inferredChild_1.getRepresentation(), "\n    </List>\n);"));
