...
var FunctionField = function (props) {
    ...
    return (0, react_1.useMemo)(function () {
        return record ? (React.createElement(Typography_1.default, __assign({ component: "span", variant: "body2", className: className }, (0, sanitizeFieldRestProps_1.default)(rest)), render(record, source))) : null;
