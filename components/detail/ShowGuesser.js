...
var ShowViewGuesser = function (props) {
    ...
    var record = (0, core_1.useShowContext)().record;
    var _a = (0, react_1.useState)(null), inferredChild = _a[0], setInferredChild = _a[1];
    (0, react_1.useEffect)(function () {
        if (record && !inferredChild) {
            var inferredElements = (0, core_1.getElementsFromRecords)([record], showFieldTypes_1.default);
            var inferredChild_1 = new core_1.InferredElement(showFieldTypes_1.default.show, null, inferredElements);
            process.env.NODE_ENV !== 'production' &&
                // eslint-disable-next-line no-console
                console.log("Guessed Show:\n\nexport const ".concat(inflection_1.default.capitalize(inflection_1.default.singularize(resource)), "Show = props => (\n    <Show {...props}>\n").concat(inferredChild_1.getRepresentation(), "\n    </Show>\n);"));
...
var ShowGuesser = function (props) {
    var controllerProps = (0, core_1.useShowController)(props);
    return (React.createElement(core_1.ShowContextProvider, { value: controllerProps },
