...
var BulkDeleteButton = function (props) {
    return props.undoable ? (React.createElement(BulkDeleteWithUndoButton_1.default, __assign({}, props))) : (React.createElement(BulkDeleteWithConfirmButton_1.default, __assign({}, props)));
};
