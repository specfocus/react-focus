...
var BulkDeleteWithConfirmButton = function (props) {
    ...
    var _e = (0, core_1.useDeleteMany)(resource, selectedIds, {
    ...
    return (React.createElement(react_1.Fragment, null,
        React.createElement(StyledButton, __assign({ onClick: handleClick, label: label, className: classes.deleteButton }, sanitizeRestProps(rest)), icon),
