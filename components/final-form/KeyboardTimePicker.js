...
exports.KeyboardTimePicker = void 0;
...
function KeyboardTimePicker(props) {
    ...
    return (react_1.default.createElement(react_final_form_1.Field, __assign({ name: name, render: function (fieldRenderProps) { return react_1.default.createElement(KeyboardTimePickerWrapper, __assign({}, fieldRenderProps, rest)); } }, fieldProps)));
}
...
function KeyboardTimePickerWrapper(props) {
    ...
    return (0, PickerProvider_1.default)(dateFunsUtils, react_1.default.createElement(DatePicker_1.KeyboardTimePicker, __assign({ fullWidth: true, 
        //autoOk={true}
