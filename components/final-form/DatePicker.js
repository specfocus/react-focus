...
function DatePicker(props) {
    ...
    return (react_1.default.createElement(react_final_form_1.Field, __assign({ name: name, render: function (fieldRenderProps) { return react_1.default.createElement(DatePickerWrapper, __assign({}, fieldRenderProps, rest)); } }, fieldProps)));
}
...
function DatePickerWrapper(props) {
    ...
    return (react_1.default.createElement(DatePicker_1.default
    // fullWidth={true}
    // autoOk={true}
    ...
    , __assign({ 
        ...
        onChange: onChange, 
        // name={name}
        value: value === '' ? null : value, renderInput: function (params) { return react_1.default.createElement(TextField_1.default, __assign({ name: name, onChange: onChange }, params)); } }, lessrest, { InputProps: restInput })));
}
