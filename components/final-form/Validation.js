...
function normalizeValidationError(err, translator) {
    return err.inner.reduce(function (errors, innerError) {
        var path = innerError.path, message = innerError.message;
...
function makeValidate(validator, translator) {
    var _this = this;
    return function (values) { return __awaiter(_this, void 0, void 0, function () {
        var err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, validator.validate(values, { abortEarly: false })];
                case 1:
                    _a.sent();
                    return [2 /*return*/, {}];
                case 2:
                    err_1 = _a.sent();
                    return [2 /*return*/, normalizeValidationError(err_1, translator)];
